...
fn main() {
    println!("sensitive   = {}", clipsync_clip::sensitive::clipboard_is_sensitive());
    println!("change_token= {:?}", clipsync_clip::change_token::clipboard_change_token());
    println!("has_image   = {:?}", clipsync_clip::formats::clipboard_has_image());
